...
from secmcp.detectors.drift import train_drift_detector_from_disk
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--detector", default="task_drift", choices=["task_drift", "rf_anchor", "logistic_diff"])
